...
function downloadExcel(rows, baseName, nsLocText = {}) {
...
export function initApp() {
    ...
    const btnExcel = getEl('btn-download-excel');
    setupDropZone({
    ...
    const btnJSON = getEl('btn-download-json');
    const btnCSV = getEl('btn-download-csv');
    setupDropZone({
